...
pdf("Output_Data/Figures/Figure_S3A.pdf", width = 4*4, height = 4*4)
grid.draw(gt)
dev.off()
...
Figure_S3_weighted = ggpairs(ISO_corr_data,
                             columns = col_order,
...
group_ranges = list(Y = c(1, 3), A = c(4, 8), S = c(9, 12))
group_colors = c(Y = "#1a7a1a", A = "#1a75ff", S = "#cc0000")
...
pdf("Output_Data/Figures/Figure_S4.pdf", width = 4*4, height = 4*4)
grid.draw(gt)
dev.off()
...
pdf("Output_Data/Figures/Figure_S4A.pdf", width = 4*4, height = 4*4)
grid.draw(gt)
dev.off()
